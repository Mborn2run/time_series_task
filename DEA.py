...
# the goal is to find the most efficient units
class DEA(object):
    ...
    def __init__(self, inputs, outputs):
        ...
        # result arrays
        self.output_w = np.zeros((self.r, 1), dtype=np.float32)  # output weights
        self.input_w = np.zeros((self.m, 1), dtype=np.float32)  # input weights
        self.lambdas = np.zeros((self.n, 1), dtype=np.float32)  # unit efficiencies
